...
void rtype::menu::HtpScreen::init()
{
    ...
    rtype::ecs::entity::Entity *c = new rtype::ecs::entity::Entity(rtype::ecs::entity::STATIC_SPRITE);
    if (c == nullptr)
        throw ScreensExceptions("HtpScreen: Error while creating Entity (10)");
    c->addComponent<ecs::component::Transform>(rtype::ecs::component::TRANSFORM, 150.f, 200.f, 0.0f, 0.0f);
    c->addComponent<ecs::component::Drawable2D>(rtype::ecs::component::DRAWABLE2D, "assets/c.png", false, sf::Vector2f(0.2f, 0.2f), 0);
    this->_world.addEntity(c);
    ...
    shootText->addComponent<ecs::component::Transform>(rtype::ecs::component::TRANSFORM, 650.f, 860.f, 0.0f, 0.0f);
    ...
    rtype::ecs::entity::Entity *skillText = new rtype::ecs::entity::Entity(rtype::ecs::entity::TEXT);
    if (skillText == nullptr)
        throw ScreensExceptions("MenuScreen: Error while creating Entity (12)");
    skillText->addComponent<ecs::component::Transform>(rtype::ecs::component::TRANSFORM, 170.f, 300.f, 0.0f, 0.0f);
    skillText->addComponent<ecs::component::Drawable2D>(rtype::ecs::component::DRAWABLE2D, "Skill", 30.f, sf::Color::Cyan, true);
    this->_world.addEntity(skillText);
