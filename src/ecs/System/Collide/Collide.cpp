...
rtype::ecs::system::Collide::Collide()
{
}
...
rtype::ecs::system::SystemType rtype::ecs::system::Collide::getSystemType() const
{
    return (rtype::ecs::system::SystemType::COLLIDESYSTEM);
}

void rtype::ecs::system::Collide::checkSphereCollision(std::unique_ptr<rtype::ecs::entity::Entity> &entity,
    std::unique_ptr<rtype::ecs::entity::Entity> &otherEntity, std::vector<int> &compoToRemove, int &count)
{
    ...
    auto collide = entity->getComponent<rtype::ecs::component::Collide>(rtype::ecs::component::COLLIDE);
    auto otherEntityTransform =
        otherEntity->getComponent<rtype::ecs::component::Transform>(rtype::ecs::component::TRANSFORM);
    auto otherEntityDrawable =
        otherEntity->getComponent<rtype::ecs::component::Drawable3D>(rtype::ecs::component::DRAWABLE3D);
    auto otherEntityCollide = entity->getComponent<rtype::ecs::component::Collide>(rtype::ecs::component::COLLIDE);
    ...
    if (rtype::raylib::BoundingBox::checkCollisionBoxSphere(
        ...
        if (entity->hasCompoType(rtype::ecs::component::COLLECTABLE) == true) {
            otherEntity->getComponent<rtype::ecs::component::Inventory>(rtype::ecs::component::INVENTORY)
                ->setBonus(entity->getComponent<rtype::ecs::component::Collectable>(rtype::ecs::component::COLLECTABLE)
                               ->getBonusType());
...
bool rtype::ecs::system::Collide::checkCollision(std::unique_ptr<rtype::ecs::entity::Entity> &entity,
