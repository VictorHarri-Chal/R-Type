...
namespace rtype
{
    ...
    namespace ecs
    {
        namespace entity
        {
             ...
             *
             */
            enum entityType { PLAYER1, PLAYER2, PLAYER3, PLAYER4, ENEMY, ALLY_PROJECTILE, ENEMY_PROJECTILE, 
            PARTICLE, HIT, HEART, COOLDOWN, HEALTHBONUS, SKILL, TEXT, RECTANGLE, STATIC_SPRITE, UNKNOWN };
            /// @brief Entity class
            class Entity {
              public:
                /**
                ...
                void remove(rtype::ecs::component::compoType type)
                {
                    ...
                    if (hasCompoType(type) == false) {
                        std::cout << "Component not found remove(): " << type << std::endl;
                        return;
                    }
                    for (auto &compo : _componentVector) {
                        it++;
                ...
                template <typename T> T *getComponent(rtype::ecs::component::compoType type)
                {
                    ...
                    std::cout << "Component not found get():" << type << std::endl;
                    return (nullptr);
                }
