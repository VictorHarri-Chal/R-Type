...
class Server {
  public:
     ...
     */
    void sendMessage(message::request type, std::string string, int value = 0);
    /**
     ...
     * @param value
     */
    void sendToClient(message::request type, udp::endpoint target_endpoint, std::string string, int value = 0);
    /**
     ...
     * @param value
     */
    void SendToAll(message::request type, std::string string, int value = 0);
    /**
     ...
     * @param value
     */
    void SendToAllInRoom(message::request type, size_t acutalId, std::string string, int value = 0);
    /**
...
class HandleCommand {
  private:
     ...
     *
     */
    std::vector<std::function<void(int, std::string, Server*, size_t)>> _allCommand;
